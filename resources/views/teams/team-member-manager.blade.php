        ...
        <div class="mt-10 sm:mt-0">
            <x-form-section submit="addTeamMember">
                ...
                <x-slot name="description">
                    {{ __('Add a new child to your family, allowing them to collaborate with you.') }}
                </x-slot>
                ...
                <x-slot name="form">
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <x-input id="fullname" type="text" class="mt-1 block w-full" wire:model="addTeamMemberForm.fullname" />
    ...
    @if ($team->teamInvitations->isNotEmpty() && Gate::check('addTeamMember', $team))
        ...
        <div class="mt-10 sm:mt-0">
            <x-action-section>
                ...
                <x-slot name="description">
                    {{ __('These people have been invited to your family and have been sent an invitation email. They may join the team by accepting the email invitation.') }}
                </x-slot>
