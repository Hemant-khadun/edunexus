<x-home-layout>
    <section class="pt-10 overflow-hidden bg-gray-50 dark:bg-gray-900 md:pt-0 sm:pt-16 2xl:pt-16">
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            <div class="grid items-center grid-cols-1 md:grid-cols-2">
    
                <div>
                    <h2 class="text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl lg:text-5xl">Hey 👋 we
                        are
                        <br class="block sm:hidden" />Edu Nexus
                    </h2>
                    <p class="max-w-lg mt-3 text-xl leading-relaxed text-gray-600 dark:text-gray-300 md:mt-8">
                        An online learning platform for kids is a virtual space where children can engage in educational activities, acquire new skills, and explore various subjects. These platforms offer interactive content, games, and lessons tailored to different age groups.
                    </p>
                    ...
                    <p class="mt-4 text-xl text-gray-600 dark:text-gray-300 md:mt-8">
                        ...
                        <br class="block sm:hidden" />Get in touch 
                        <br>
                        <br>
